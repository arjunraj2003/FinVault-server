...
const transaction_category_enum_1 = require("../transaction-category.enum");
exports.createBudgetSchema = joi_1.default.object({
    amount: joi_1.default.number().positive().required(),
    category: joi_1.default.string().valid(...Object.values(transaction_category_enum_1.TransactionCategory)).required(),
...
exports.updateBudgetSchema = joi_1.default.object({
    ...
    category: joi_1.default.string().valid(...Object.values(transaction_category_enum_1.TransactionCategory)).optional(),
